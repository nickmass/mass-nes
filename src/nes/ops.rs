...
impl Op {
    pub fn load() -> HashMap<u8, Op> {
        ...
        let mut h = HashMap::new();
        {
            ...
            o(0xbd, I::Lda, A::AbsoluteX(DummyRead::OnCarry));
            ...
            o(0xbe, I::Ldx, A::AbsoluteY(DummyRead::OnCarry));
            ...
            o(0x9d, I::Sta, A::AbsoluteX(DummyRead::Always));
            ...
            o(0x7d, I::Adc, A::AbsoluteX(DummyRead::OnCarry));
            ...
            o(0xfd, I::Sbc, A::AbsoluteX(DummyRead::OnCarry));
            ...
            o(0x3d, I::And, A::AbsoluteX(DummyRead::OnCarry));
            ...
            o(0x5d, I::Eor, A::AbsoluteX(DummyRead::OnCarry));
            ...
            o(0x1d, I::Ora, A::AbsoluteX(DummyRead::OnCarry));
            ...
            o(0xdd, I::Cmp, A::AbsoluteX(DummyRead::OnCarry));
            ...
            o(0xbf, I::IllLax, A::AbsoluteY(DummyRead::OnCarry));
            o(0xa3, I::IllLax, A::IndirectX);
            o(0xb3, I::IllLax, A::IndirectY(DummyRead::OnCarry));

            o(0x07, I::IllSlo, A::ZeroPage);
            o(0x17, I::IllSlo, A::ZeroPageX);
            o(0x0f, I::IllSlo, A::Absolute);
            o(0x1f, I::IllSlo, A::AbsoluteX(DummyRead::Always));
            o(0x1b, I::IllSlo, A::AbsoluteY(DummyRead::Always));
            o(0x03, I::IllSlo, A::IndirectX);
            o(0x13, I::IllSlo, A::IndirectY(DummyRead::Always));

            o(0x27, I::IllRla, A::ZeroPage);
            o(0x37, I::IllRla, A::ZeroPageX);
            o(0x2f, I::IllRla, A::Absolute);
            o(0x3f, I::IllRla, A::AbsoluteX(DummyRead::Always));
            ...
            o(0x5f, I::IllSre, A::AbsoluteX(DummyRead::Always));
            ...
            o(0x7f, I::IllRra, A::AbsoluteX(DummyRead::Always));
            ...
            o(0xdf, I::IllDcp, A::AbsoluteX(DummyRead::Always));
            ...
            o(0xff, I::IllIsc, A::AbsoluteX(DummyRead::Always));
            ...
            o(0x93, I::IllAhx, A::IndirectY(DummyRead::Always));
            o(0x9f, I::IllAhx, A::AbsoluteY(DummyRead::Always));
            o(0x9c, I::IllShy, A::AbsoluteX(DummyRead::Always));
            ...
            o(0x1c, I::IllNop, A::AbsoluteX(DummyRead::OnCarry));
            o(0x3c, I::IllNop, A::AbsoluteX(DummyRead::OnCarry));
            o(0x5c, I::IllNop, A::AbsoluteX(DummyRead::OnCarry));
            o(0x7c, I::IllNop, A::AbsoluteX(DummyRead::OnCarry));
            o(0xdc, I::IllNop, A::AbsoluteX(DummyRead::OnCarry));
            o(0xfc, I::IllNop, A::AbsoluteX(DummyRead::OnCarry));
