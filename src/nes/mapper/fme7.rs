        ...
        match rom.command {
            ...
            8 => {
                ...
                if rom.ram_enable {
                    ...
                    rom.prg
                        .map(0x6000, 8, (rom.parameter & 0x3f) as usize, BankKind::Rom);
                }
            }
            9 => rom
                .prg
                .map(0x8000, 8, (rom.parameter & 0x3f) as usize, BankKind::Rom),
            0xa => rom
                .prg
                .map(0xa000, 8, (rom.parameter & 0x3f) as usize, BankKind::Rom),
            0xb => rom
                .prg
                .map(0xc000, 8, (rom.parameter & 0x3f) as usize, BankKind::Rom),
            0xc => match rom.parameter & 0x3 {
